package com.dakewe.core.launch;

import com.dakewe.core.launch.constant.AppConstant;
import com.dakewe.core.launch.constant.NacosConstant;
import com.dakewe.core.launch.constant.SentinelConstant;
import com.dakewe.core.launch.service.LauncherService;
...
public class ZingApplication {
	...
	public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
		...
		String startJarPath = ZingApplication.class.getResource("/").getPath().split("!")[0];
		...
		props.setProperty("app.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
		props.setProperty("app.service.version", AppConstant.APPLICATION_VERSION);
