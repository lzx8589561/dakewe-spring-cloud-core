package com.dakewe.core.secure.aspect;

import org.aspectj.lang.ProceedingJoinPoint;
import org.aspectj.lang.annotation.Around;
import org.aspectj.lang.annotation.Aspect;
import org.aspectj.lang.reflect.MethodSignature;
import com.dakewe.core.secure.annotation.PreAuth;
import com.dakewe.core.secure.auth.AuthFun;
import com.dakewe.core.secure.exception.SecureException;
import com.dakewe.core.tool.api.ResultCode;
import com.dakewe.core.tool.utils.ClassUtil;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(com.dakewe.core.secure.annotation.PreAuth) || " +
			"@within(com.dakewe.core.secure.annotation.PreAuth)"
	)
