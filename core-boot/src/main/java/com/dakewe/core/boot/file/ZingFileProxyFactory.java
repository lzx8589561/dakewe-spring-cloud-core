...
import com.dakewe.core.tool.utils.ImageUtil;
 ...
 * @author Zing
 */
public class ZingFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{ZingFileUtil.formatUrl(uploadPath.toString()), ZingFileUtil.formatUrl(virtualPath.toString())};
	}
