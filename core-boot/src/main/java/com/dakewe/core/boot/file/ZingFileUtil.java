...
public class ZingFileUtil {
	 ...
	 * @return File
	 */
	public static ZingFile getFile(MultipartFile file) {
	 ...
	 * @return File
	 */
	public static ZingFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return File
	 */
	public static ZingFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new ZingFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return File
	 */
	public static List<ZingFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return File
	 */
	public static List<ZingFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return File
	 */
	public static List<ZingFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<ZingFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new ZingFile(file, dir, path, virtualPath));
		}
		return list;
	}
